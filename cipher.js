...
function input() {
  if (document.getElementById("message").value.length != 0 && document.getElementById("key").value.length != 0) {
    for (let i = 0; i < 26; i++) {
...
function inputDecoded() {
  if (document.getElementById("messageDec").value.length != 0 && document.getElementById("keyDec").value.length != 0) {
    for (let i = 0; i < 26; i++) {
      cipherMatrix[i] = new Array(26);
    }
